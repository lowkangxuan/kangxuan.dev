...
const components = {
    h1: (props) => <h1 className="font-geist text-2xl font-semibold mt-12 mb-4" {...props} />,
    h2: (props) => <h2 className="font-geist text-xl font-semibold mt-12 mb-4" {...props} />,
    h3: (props) => <h3 className="font-geist text-lg font-semibold mt-8 mb-4" {...props} />,
